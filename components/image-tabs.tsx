"use client";
// usclient is used to make the component a client component, it is necessary to use state or effects in the component, like onclick on buttons or useState
