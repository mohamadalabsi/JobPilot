...
//  for devs , and this is the id od the user we want to seed the data for
const USER_ID = "69c11d5eb7920b3007e3f31d";
...
//!  add it in package.json alongside the local.env 
// "seed:jobs": "tsx --env-file=.env.local scripts/seed.ts"
//   run npm i tsx --save-dev
//  then run it with the command npm run seed:jobs
//  restart the applocation after seeding to see the changes in the UI
